...
<head>
    ...
    <link rel="stylesheet" href="./css/sellupdatereply.css?after">
	...
	<div id="whiteOneFrame">
		<div id="mainFrame">
			...
			<div id="contenttitleFrame">
				...
				<div class="contentinfo"><%=rdto.getId() %></div>					
			</div>
					
			<div id="ContentFrameR">
				<div class="writeinfo">댓글</div>
				<div id="Ccontentframe"><textarea rows="19" cols="1000" name="content"><%=rdto.getContent() %></textarea></div>
			</div>
