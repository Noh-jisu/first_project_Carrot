...
<head>
    ...
    <link rel="stylesheet" href="./css/sellupdatebbs.css?after">
	...
	<div id="whiteOneFrame">
		<div id="mainFrame">
			...
			<div id="CtitleFrame">
				...
				<div class="contentinfo"><textarea rows="1" cols="100" name="title"><%=cdto.getTitle() %></textarea></div>
			</div>
					
			<div id="ContentFrameC">
				<div class="writeinfo">내용</div>
				<div id="Ccontentframe"><textarea rows="19" cols="1000" name="content"><%=cdto.getContent() %></textarea></div>
			</div>
